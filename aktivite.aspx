<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="aktivite.aspx.cs" Inherits="aktivite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/image/aktivite.png" />
    </div>
