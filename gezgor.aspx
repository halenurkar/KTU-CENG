<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="gezgor.aspx.cs" Inherits="gezgor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
       <asp:Image ID="Image1" ImageUrl="~/image/gezgor.png"  runat="server" />
    </div>
