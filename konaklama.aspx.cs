...
public partial class konaklama : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            SqlDataAdapter da4 = new SqlDataAdapter("select email ,isim, yorum from yorum4 y INNER JOIN login on y.kullaniciId =login_Id  order by  y.id desc  ", connection);
    ...
    public void Yorum_gonder()
    {
        try
        {
            ...
            SqlDataAdapter sqlveriadaptoru = new SqlDataAdapter("INSERT INTO yorum4( yorum,kullaniciId) values(@y,@k)", connection);
            ...
            SqlDataAdapter sqlveriadaptoru2 = new SqlDataAdapter("select email ,isim, yorum from yorum4 y INNER JOIN login on y.kullaniciId =login_Id  order by  y.id desc ", connection);
