<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ulasım.aspx.cs" Inherits="ulasım" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        .box{border-style:groove; border-color:#ff6a00; border-radius:20px; width:320px; height:40px;  }
        .button{border-style:groove; border-color:#ff6a00; border-radius:20px; width:100px; height:35px; background-color:white;}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/image/ulaşım.png" Height="885px" />
    </div>
    ...
    <table class="table">
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="GÖNDER"  CssClass="button" OnClick="Yorum_yap"/> </td>
        </tr>
    </table>
