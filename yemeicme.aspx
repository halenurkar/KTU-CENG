<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="yemeicme.aspx.cs" Inherits="yemeicme" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        <asp:Image ID="Image1" ImageUrl="~/image/yemeicme.png" runat="server" />
    </div>
